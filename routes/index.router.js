...
//report routes
router.post('/sendReport/:fId/:tId/:iId',reports.addReport);//send request
router.get('/viewRequest/:uId',reports.reportView);//view requests
router.put('/status/:uId/:rId',reports.status);//accept or reject
router.get('/reportideas/:uId',reports.reportIdeas);//view ideas invested
router.get('/reportstatus/:uId/:iId',reports.reportstatus);
